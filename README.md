...
및 상기 바디부의 타측변에 소정 높이 단차지게 형성되되 상기 제1 단차부와 다른 높이로
단차지게 형성되는 제2 단차부;를 포함하는 색편제조용 단층형성도구가 제공된다.

... (중략) ...

상기 색편제조용 단층형성 도구는 각각 다른 곡률을 갖는 제1 및 제2 곡률부를 구비하는 바디부가 복수로 이루어지는 세트로 구성되고, 
